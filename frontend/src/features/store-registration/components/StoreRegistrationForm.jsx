...
const STEPS = [
  { num: 1, label: 'Datos del almacen', fields: ['nombreAlmacen', 'cedulaJuridica', 'direccion', 'telefono', 'email', 'descripcion'] },
...
export function StoreRegistrationForm() {
  ...
  return (
    <form className="store-reg-form" noValidate >
      ...
      {/* Step 1: Datos del almacen */}
      {step === 1 && (
        <div className="form-card">
          <h3>Datos del almacen</h3>
          <p className="form-card-sub">Informacion publica del comercio.</p>
          <div className="field-grid">
            <Field label="Nombre del almacen" name="nombreAlmacen" value={form.nombreAlmacen} error={errors.nombreAlmacen} onChange={updateField} />
      ...
      {step === 2 && (
        <div className="form-card">
          ...
          <p className="form-card-sub">Agrega las personas que trabajaran en este comercio. Los funcionarios deben ser usuarios registrados en OpenPaw. Puedes saltar este paso y agregarlos mas tarde desde el panel de funcionarios.</p>
          {team.length === 0 && (
      ...
      {step === 3 && (
        <div className="form-card">
          ...
          <p className="form-card-sub">Documento de constitucion en PDF.</p>
          <FileUploadField
            name="documentoConstitucion"
            accept="application/pdf,.pdf"
            summary={fileSummary}
            error={errors.documentoConstitucion}
